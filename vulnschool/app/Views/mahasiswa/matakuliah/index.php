...
<?php if (!$mahasiswa): ?>
    <div class="alert alert-warning">
        <i class="bi bi-exclamation-circle me-2"></i>Profil mahasiswa Anda belum terdaftar. Hubungi admin.
    </div>
<?php elseif (empty($mataKuliah)): ?>
    <div class="card vs-card">
        <div class="card-body text-center py-5">
            <i class="bi bi-book text-muted" style="font-size:3rem;"></i>
            <h5 class="mt-3 text-muted">Belum Ada Mata Kuliah</h5>
            <p class="text-muted mb-0">Anda belum terdaftar di mata kuliah manapun semester ini.</p>
        </div>
    </div>
<?php else: ?>
...
<div class="card vs-card">
    <div class="card-header">
        <span><i class="bi bi-journal-text me-2"></i>Daftar Mata Kuliah</span>
    </div>
                ...
                <tbody>
                    <?php foreach ($mataKuliah as $i => $mk): ?>
                        <tr>
                            ...
                            <td style="font-size:.85rem;"><?= esc($mk['nama_dosen'] ?? '-') ?></td>
                            <td>
                                <a href="/mahasiswa/mata-kuliah/<?= $mk['id'] ?>" class="btn btn-sm btn-outline-primary">
